...
public:
    ...
    void setupUi(QDialog *Server)
    {
        ...
        Server->resize(651, 469);
        QSizePolicy sizePolicy(QSizePolicy::Fixed, QSizePolicy::Fixed);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(Server->sizePolicy().hasHeightForWidth());
        Server->setSizePolicy(sizePolicy);
        Server->setMinimumSize(QSize(600, 400));
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/IconsServer/myicons-server.png"), QSize(), QIcon::Normal, QIcon::Off);
        Server->setWindowIcon(icon);
        Server->setStyleSheet(QString::fromUtf8("QDialog#Server{\n"
...
"}"));
        ...
        QBrush brush1(QColor(13, 23, 43, 255));
        brush1.setStyle(Qt::SolidPattern);
        palette.setBrush(QPalette::Active, QPalette::Button, brush1);
        QBrush brush2(QColor(20, 34, 65, 255));
        brush2.setStyle(Qt::SolidPattern);
        palette.setBrush(QPalette::Active, QPalette::Light, brush2);
        QBrush brush3(QColor(16, 28, 54, 255));
        brush3.setStyle(Qt::SolidPattern);
        palette.setBrush(QPalette::Active, QPalette::Midlight, brush3);
        QBrush brush4(QColor(6, 11, 21, 255));
        brush4.setStyle(Qt::SolidPattern);
        palette.setBrush(QPalette::Active, QPalette::Dark, brush4);
        QBrush brush5(QColor(9, 15, 29, 255));
    ...
    {
        Server->setWindowTitle(QCoreApplication::translate("Server", "PDS Server", nullptr));
    } // retranslateUi
